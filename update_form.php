...
<div class=" d-flex justify-content-center ">
    <div class="col-8">
<form action="update_script.php" methode="get" enctype="multipart/form-data" class="w-100 mt-4">
...
<?php };?>
    <div class="row w-100 d-flex justify-content-center mb-4">
        <button class="ml-4 rounded btn-dark text-light btn"name="id" value="<?=$disc->disc_id?>" >Ajouter</button>
        <input type="submit" href="index.php?page=liste" class="ml-4 rounded btn-dark text-light btn" name="Retour">
    </div>
</form>
</div>
</div>
